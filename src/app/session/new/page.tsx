      ...
      <div className="sticky top-0 z-10 bg-black/90 backdrop-blur-sm border-b border-zinc-800">
        <div className="max-w-lg mx-auto px-4 pt-3 pb-3">
          <div className="flex items-center gap-2 mb-2">
            <h1 className="text-sm font-medium text-white shrink-0">New Session</h1>
            <span
              title={locationStatus === 'ok' ? 'Location acquired' : locationStatus === 'acquiring' ? 'Getting location...' : 'Location unavailable'}
              className={`shrink-0 ${locationStatus === 'ok' ? 'text-green-500' : locationStatus === 'acquiring' ? 'text-orange-400 animate-pulse' : 'text-zinc-600'}`}
            >
