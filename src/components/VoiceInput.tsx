  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className={`flex items-center justify-center gap-2 w-1/2 py-2.5 rounded-lg text-sm font-medium transition-colors ${
          listening
      ...
      <button
        type="button"
        onClick={toggleLang}
        className="text-sm text-zinc-500 hover:text-zinc-300 px-3 py-2.5 rounded-lg border border-zinc-800 hover:border-zinc-600"
